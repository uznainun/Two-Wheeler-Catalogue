<%@ Page Title="" Language="C#" MasterPageFile="~/DealerModule/DealerMasterPage.master" AutoEventWireup="true" CodeFile="DealerDeleateAccount.aspx.cs" Inherits="DealerModule_DealerDeleateAccount" %>
                        ...
                        <div class="col-lg-6">
                            <div class="login-content">
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <asp:Button ID="Button1" runat="server" CausesValidation="False" class="btn btn-success" OnClick="Button1_Click" Text="leave" />
                                        </div>
                                        <div class="col-6">

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminChangePassword.aspx.cs" Inherits="AdminModule_AdminChangePassword" %>
                            ...
                            <div class="login-content">
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtpassword" ControlToValidate="txtreenterpassword" Display="Dynamic" ErrorMessage="password mis-matached" ForeColor="Red"></asp:CompareValidator>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">

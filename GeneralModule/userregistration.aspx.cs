...
public partial class GeneralModule_userregistration : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (obj.dr.HasRows)
        {
            ...
            MailMessage m = new MailMessage("mailtobaist74@gmail.com", txtemailid.Text, "OTP", "hi user your otp is :  " + n.ToString());
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        n = r.Next(1000, 10000);
        ViewState["otp"] = n.ToString();
        MailMessage m = new MailMessage("mailtobaist74@gmail.com", txtemailid.Text, "<b>OTP</b>", "hi user your new otp is :" + n.ToString());
        m.IsBodyHtml = true;
        SmtpClient sc = new SmtpClient();
        sc.EnableSsl = true;
        sc.Port = 587;
        ...
        if (FileUpload1.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                if (obj.dr.HasRows)
                {
                    ...
                    MailMessage m = new MailMessage("mailtobaist74@gmail.com", txtemailid.Text, "Account username and password", "Dear, " + txtname.Text + " congratulations you are sucessfully registered as a new user <br />Your user name is : " + txtemailid.Text + "<br />password is : " + psw);
                    m.IsBodyHtml = true;
                    SmtpClient sc = new SmtpClient();
                    sc.EnableSsl = true;
                    sc.Port = 587;

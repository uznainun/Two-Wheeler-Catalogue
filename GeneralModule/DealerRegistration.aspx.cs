...
public partial class GeneralModule_DRegistration : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (obj.dr.HasRows)
        {
            ...
            //MailMessage m = new MailMessage("UznainUN@gmail.com", txtemailid.Text, "OTP", "hi user your otp is :  " + n.ToString());
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        n = r.Next(1000, 10000);
        ViewState["otp"] = n.ToString();
        MailMessage m = new MailMessage("UznainUN@gmail.com", txtemailid.Text, "OTP  - From UznainUN@Gmail.com", "hi dealer your new otp is :  " + n.ToString());
        m.IsBodyHtml = true;
        SmtpClient sc = new SmtpClient();
        sc.EnableSsl = true;
        sc.Port = 587;
        ...
        sc.Send(m);
        Response.Write("<script>alert('" + n.ToString() + "');</script>");
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                connectionclass obj = new connectionclass();
                obj.exe_Command(str);
                str = "select max(d_id) from dealerregistration";
                obj.datareader(str);
                if (obj.dr.HasRows)
                {
                    obj.dr.Read();
                    ...
                    str = "update dealerregistration set d_dp='" + dp_name + "' where d_id=" + obj.dr[0].ToString();
                    obj.exe_Command(str);
                    FileUpload1.SaveAs(Server.MapPath("../DealerModule/images/" + dp_name));


                    twoweelercatalog obj2 = new twoweelercatalog();
                    obj2.gettype(ddltype);
                    obj2.refreshbrands(ddltype, chkbrand);
                    MultiView1.ActiveViewIndex = 3;
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        if (obj.dr.HasRows)
        {
            ...
            //MailMessage m = new MailMessage("UznainUN@gmail.com", txtemailid.Text, "Account username and password", "Dear, " + txtname.Text + " congratulations you are sucessfully registered as a new user <br />Your user name is : " + txtemailid.Text + "<br />password is : " + psw);
            //m.IsBodyHtml = true;
            //SmtpClient sc = new SmtpClient();
            //sc.EnableSsl = true;
            //sc.Port = 587;
            ////sc.Send(m);
            str = "insert into pending_registration values(" + Session["d_id"].ToString() + ");";
            obj.exe_Command(str);

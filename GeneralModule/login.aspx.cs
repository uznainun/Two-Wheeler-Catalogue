...
public partial class GeneralModule_login : System.Web.UI.Page
{
    ...
    protected void btrecover_Click(object sender, EventArgs e)
    {
        ...
        if (obj.dr.HasRows)
        {
            ...
            MailMessage m = new MailMessage("mailtobaist74@gmail.com", txtforgotemailid.Text, "Account Passsword Recovery", "Dear, " + obj.dr[1].ToString() + ", Your new password is : " + psw);
            m.IsBodyHtml = true;
